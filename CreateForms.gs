...
/**
* gets the names of all the bid sheets associated with forms
* this is only used for by the clearTestingData function
**/
...
/**
* unlinks each bid sheet from form
* deletes each bid sheet
* deletes each biding form
* clears the contents of the auctionFormInfo sheet
**/
